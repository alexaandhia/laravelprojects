				...
				<table class="table table-hover shadow-sm">
					...
					<tbody>
						...
						<tr>
							...
							<td><a href="/pembayaran/admin/detailpendaftaran/{{$student->user_id}}"><button class="btn btn-primary " style="color: white">Detail</button></a></td>
							<td>
