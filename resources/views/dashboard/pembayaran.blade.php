...
<x-layout-app title="Pembayaran PPDB">
	...
	<div class="container-xl">
		...
		@elseif($item->status == 1)
		<div class="alert alert-success  w-75" style="margin-left: 20px">Terimakasih! Pembayaran Telah Terverifikasi,
			harap tunggu info selanjutnya</div>

		@elseif($item->status == 2)
		<div class="alert alert-danger mb-5 w-75" style="margin-left: 20px">Pembayaran di Ditolak, Silahkan Isi Ulang Data!</div>
		<div class="app-card shadow-sm mb-4 px-10">
		</div>
		<div class="app-card shadow-sm mb-4 px-10">
		...
		<div class="alert alert-warning w-75" style="margin-left: 20px">Masih Tertunda, Tunggu Admin Verifikasi dulu ya!
		</div>
		@endif
