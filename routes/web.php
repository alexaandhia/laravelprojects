...
Route::get('/', [UserController::class, 'landpage'])->name('landpage');
...
Route::middleware(['isLogin', 'cekRole:admin'])->group(function () {
    ...
    Route::get('/pembayaran/admin/detailpendaftaran/{pembayaran:user_id}', [DashboardController::class, 'detail_pendaftaran'])->name('detail.pendaftaran');
    ...
    Route::get('/pembayaran/all', [DashboardController::class, 'pembayaran_all'])->name('pembayaran.all');
});

Route::middleware(['isLogin', 'cekRole:user'])->group(function () {
    Route::get('pembayaran', [PembayaranController::class, 'index'])->name('pembayaran');
    Route::post('pembayaran/user', [PembayaranController::class, 'store'])->name('pembayaran.store');  
